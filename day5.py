...
def run_code(L):
    ...
    while pc < n:
        ...
        if opcode in [1, 2]:
            op1 = L[pc + 1] if not(len(modes) < 1 or modes[0] == "0") else L[L[pc+1]]
            op2 = L[pc + 2] if not(len(modes) < 2 or modes[1] == "0") else L[L[pc+2]]
            add = L[pc + 3]
        ...
        # Print output
            ...
            x = L[pc + 1] if not(len(modes) < 1 or modes[0] == "0") else L[L[pc+1]] 
            print("Output:", x)
            pc += 2
